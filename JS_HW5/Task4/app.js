...
function handleClick(clickedButtonEvent) {
    ...
    const card = {
        ...
        button: cardNode.children[cardNode.children.length - 1], // здесь button, который внутри .product
    };
...
function hideMoreText(card) {
    ...
    //=============================================
    // мне кажется тут должно быть более элегантное решение чем обращение по номеру элемента массива
    // также и в "const card"
    // но как это сделать не разобрался
    //=============================================
    
    card.wrap.childNodes[5].remove();
