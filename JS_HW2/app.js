...
d = 2 + b++; 
alert(d); //ответ: 4 
// получаем 4 тк в примере 2 мы уже применили инкремент к b. 
//При первом запросе результата возвращалось старое значение. 
//А сейчас мы запросили результат второй раз и получаем новое значение 2. 
...
//Task 2  Чему будут равны переменные x и f в примере ниже? 
...
let x = 1 + (f *= 2); // оператором *= мы умножаем значение переменой f на 2 
//и записываем значение в f (4). Результат складываем с 1. Получаем x = 5, f = 4.
...
//Task 4   Реализовать основные 4 арифметические операции (+, -, /, *) в виде функций 
...
//Task 6**  (Сложное задание, требует времени и возможно гугления, делайте по желанию.) 
